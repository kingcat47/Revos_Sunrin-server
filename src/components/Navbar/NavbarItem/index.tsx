...
export default function NavbarItem() {
    ...
    {isDropdownOpen && (
        <ul className={styles.dropdown}>
            ...
            <div
                className={styles.dropdown_item}
                onClick={() => handleDropdownClick('경제')}
            >
                경제
            </div>
            <div
                className={styles.dropdown_item}
                onClick={() => handleDropdownClick('과학/IT')}
            >
                과학/IT
            </div>
            <div
                className={styles.dropdown_item}
                onClick={() => handleDropdownClick('사회')}
            >
                사회
            </div>
            <div
                className={styles.dropdown_item}
                onClick={() => handleDropdownClick('국제')}
            >
                국제
            </div>
            <div
                className={styles.dropdown_item}
                onClick={() => handleDropdownClick('문화')}
            >
                문화
            </div>
            <div
                className={styles.dropdown_item}
                onClick={() => handleDropdownClick('연예')}
            >
                연예
            </div>
            <div
                className={styles.dropdown_item}
                onClick={() => handleDropdownClick('스포츠')}
            >
                스포츠
            </div>
            <div
